...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#0B192C]">
      {/* Dynamic Water-Inspired Background */}
      <div className="absolute inset-0 z-0">
        {/* The new industrial water treatment plant image */}
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: 'url("/assets/projects/aerial-treatment-plant.jpeg")' }}
        ></div>
        ...
        <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-[#00B4D8]/10 blur-[120px] rounded-full mix-blend-overlay"></div>
        <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-[#48CAE4]/10 blur-[120px] rounded-full mix-blend-overlay"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            <Link 
              to="/solutions"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#00B4D8] text-[#0B192C] font-semibold rounded-sm hover:bg-white transition-all duration-300 group"
            >
