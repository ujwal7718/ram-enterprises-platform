    ...
    <section className="relative min-h-[65vh] flex items-center pt-24 pb-16 overflow-hidden bg-[#0B192C]">
      ...
      <div className="absolute inset-0 z-0">
        <div 
          ...
          style={{ backgroundImage: 'url("/assets/equipment/water-treatment-system.jpeg")' }}
        ></div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            Explore treatment systems, filtration technologies and engineering solutions designed around industrial and operational requirements.
          </motion.p>
