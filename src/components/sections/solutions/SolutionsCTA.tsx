  ...
  return (
    <section className="py-24 relative overflow-hidden bg-[#0B192C]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="absolute bottom-0 w-full h-1/2 opacity-10">
          <path d="M0,50 Q25,30 50,50 T100,50 L100,100 L0,100 Z" fill="#48CAE4" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
            Have a Water or Industrial <br className="hidden md:block" /> Engineering Requirement?
          </h2>
          
          <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
            Tell us about your requirement and our team can discuss the appropriate engineering and treatment approach.
          </p>
