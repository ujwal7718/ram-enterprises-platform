      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {capabilities.map((cap, index) => (
            ...
            >
              <TiltCard strength={6} className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm text-center hover:shadow-lg hover:border-[#00B4D8]/30 transition-shadow duration-300 h-full">
